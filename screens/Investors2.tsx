		...
		return (
			<View style={{ flexDirection: 'row',backgroundColor:COLORS.sky,}}>
				...
				<View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
						<Text style={{textAlign:'center',...FONTS.h4,right:12,color:COLORS.white}}>អ្នកបោះទុន</Text>
				</View>
			</View>
		)
	}
	...
	function renderButton() {
		return (
			<View style={{flex:1,justifyContent:'flex-end',alignItems:'flex-end',marginBottom:20,marginEnd:20}}>
				<TouchableOpacity style={{width:50,height:50,backgroundColor:COLORS.Skyblue,borderRadius:30,justifyContent:'center',alignItems:'center'}} onPress={()=>navigation.navigate(routes.Addinvestors)}>
