	...
	function renderButton(){
		return (
			<View style={{alignItems:'flex-end',justifyContent:'center',marginBottom:40,marginRight:20}}>
				<TouchableOpacity style={{width:50,height:50,borderRadius:30,backgroundColor:COLORS.sky,justifyContent:'center',alignItems:'center'}}>
...
export default Additionalcapital2